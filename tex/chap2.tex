...
The Deep Zoom Image (DZI)\nomenclature{DZI}{Deep Zoom Image} format is an XML-based file format, developed and maintained by Microsoft\cite{web:dzi}. A DZI is a pyramidcal, tiled image, similar to the one described in \cite{DICOM10}, with two exceptions:
\begin{enumerate}
