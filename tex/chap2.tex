...
\cite{web:jpeg2000} describes JPEG 2000 as follows:
\begin{quotation}
...
JPEG 2000 is an image compression standard and coding system. It was created by the Joint Photographic Experts Group committee in 2000 with the intention of superseding their original JPEG standard. This should be accomplished through the use of a novel wavelet based approach\cite{web:jpeg2000}.

The improved standard has certain benefits over its predecessor\cite{intoPix08}:
\begin{itemize}
	\item \textbf{improved compression efficiency}
	\item \textbf{mathematically lossless compression}
	\item \textbf{graceful degradation}
	\item \textbf{scalability}
	\item \textbf{dynamic bandwidth allocation}
	\item \textbf{scalability and adaptive reception}
	\item \textbf{robust transmission}
	\item \textbf{easy post-production}
	\item \textbf{region of interest}
	\item \textbf{low latency}
	\item \textbf{encoding-decoding processing power}
\end{itemize}


The code streams are regions of interest that offer several mechanisms to support spatial random access or region of interest access at varying degrees of granularity. It is possible to store different parts of the same picture using different quality.
