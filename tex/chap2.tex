...
Since the proprietary formats have little to no documentation, most of the information presented here was reverse engineered in \cite{Goode13} and \cite{web:openslide}.
...
The Deep Zoom Image (DZI)\nomenclature{DZI}{Deep Zoom Image} format is an XML-based file format, maintained by Microsoft. A DZI is a pyramidcal, tiled image as described in 2.1.\cite{web:dzi}. It consists of two parts: 
\begin{enumerate}[(1)]
