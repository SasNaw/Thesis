...
Since the test images are of enormous size, they are not delivered via the repository. Instead they need to be downloaded separately from the OpenSlide homepage\footnote{see \url{http://openslide.cs.cmu.edu/download/openslide-testdata/}}, where a freely distributable test data can be found.

See Appendix A for a listing of all the WSIs in the test data.
