...
\review{Tabelle ist inkonsistent: zum einen gib es "perl utility" (Programmiersprache + utility) und zum anderen Python/PHP (Nur die sprache) und zum dritten fließtext + ruby}
