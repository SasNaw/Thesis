...
For a detailed explanation of the single functions of ASS and ASV, see Appendix B.1 and B.2.
...
The ASS is a local web server written in python. Additionally, frameworks have been used for improved functionality. Those were: 
...
Through the use of those 2 functions, the ASS can create the metadata for a DZI on demand and pass it to the ASV, which in return requests the single needed 
