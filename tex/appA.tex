...
\section{Files on CD}
\label{secA_cd}
All files of the AS are openly available in its GitHub repository. Additionally, a manual with installation and usage instructions can be found there. The repository can be found at:
